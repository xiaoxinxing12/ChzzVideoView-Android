...
public class CHZZVideoView extends SurfaceView
        implements CHZZMediaController.MediaPlayerControl,OrientationDetector.OrientationChangeListener{
    ...
    private CHZZMediaController mMediaController;
    ...
    public CHZZVideoView(Context context) {
        this(context,null);
    }

    public CHZZVideoView(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public CHZZVideoView(Context context, AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);
        mContext = context;
        TypedArray a = mContext.obtainStyledAttributes(attrs, R.styleable.CHZZVideoView,0,0);
        mFitXY = a.getBoolean(R.styleable.CHZZVideoView_uvv_fitXY, false);
        mAutoRotation = a.getBoolean(R.styleable.CHZZVideoView_uvv_autoRotation, false);
        a.recycle();
        initVideoView();
    }
    ...
    public void onInitializeAccessibilityEvent(AccessibilityEvent event) {
        ...
        event.setClassName(CHZZVideoView.class.getName());
    }
    ...
    public void onInitializeAccessibilityNodeInfo(AccessibilityNodeInfo info) {
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.ICE_CREAM_SANDWICH) {
            info.setClassName(CHZZVideoView.class.getName());
        }
    }
    ...
    public void setMediaController(CHZZMediaController controller) {
...
//                    }
    ...
    private void enableOrientationDetect() {
        if (mAutoRotation && mOrientationDetector == null) {
            ...
            mOrientationDetector.setOrientationChangeListener(CHZZVideoView.this);
